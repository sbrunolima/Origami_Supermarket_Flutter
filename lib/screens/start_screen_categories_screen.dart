...
class StartScreenCategories extends StatefulWidget {
  static const routeName = '/start-screen-catedory';

  @override
  State<StartScreenCategories> createState() => _StartScreenCategoriesState();
}

class _StartScreenCategoriesState extends State<StartScreenCategories> {
  var _isInit = true;
  var title;
