...
class FinishCardScreen extends StatefulWidget {
  static const routeName = '/finish-card-screen';

  @override
  State<FinishCardScreen> createState() => _FinishCardScreenState();
}

class _FinishCardScreenState extends State<FinishCardScreen> {
